...
public class SpaceMissileSymbolSetInfo implements SymbolSetInfo {
    public static final SymbolSetInfo INSTANCE = new SpaceMissileSymbolSetInfo();
    private static final List<Entity> ENTITIES = Arrays.asList(SpaceMissileEntity.values());

    private SpaceMissileSymbolSetInfo() {
    }
    ...
    public List<SectorOneModifier> getSectorOneModifiers() {
        return Arrays.asList(SpaceMissileSectorOneModifier.values());
    }

    @Override
    public List<SectorTwoModifier> getSectorTwoModifiers() {
        return Arrays.asList(SpaceMissileSectorTwoModifier.values());
    }
