...
public enum LandCivilianEntityType implements EntityType {
    ...
    ORGANIZATION("04", "Organization or Group", LandCivilianEntity.CIVILIAN, IconType.MAIN),
    KILLING_VICTIM("05", "Killing Victim", LandCivilianEntity.CIVILIAN, IconType.MAIN),
    KILLING_VICTIMS("06", "Killing Victims", LandCivilianEntity.CIVILIAN, IconType.MAIN),
