package io.github.ctgnz.jmsfx.hallux.activity;
...
public class ActivitySymbolSet implements SymbolSetInfo {
    public static final SymbolSetInfo INSTANCE = new ActivitySymbolSet();
    ...
    private ActivitySymbolSet() {
    }

    @Override
    public List<AmplifierGuide> getAmplifierGuides() {
        return Arrays.asList(ActivityAmplifierGuide.values());
    }
