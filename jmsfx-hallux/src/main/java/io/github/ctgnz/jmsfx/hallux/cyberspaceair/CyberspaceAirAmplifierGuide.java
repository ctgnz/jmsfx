package io.github.ctgnz.jmsfx.hallux.cyberspaceair;
...
public enum CyberspaceAirAmplifierGuide implements AmplifierGuide {
    ...
    CyberspaceAirAmplifierGuide(AmplifierEnum amplifier, GuideType type, double... points) {
