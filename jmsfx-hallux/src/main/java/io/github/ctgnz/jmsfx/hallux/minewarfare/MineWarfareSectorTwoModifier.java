package io.github.ctgnz.jmsfx.hallux.minewarfare;
...
public enum MineWarfareSectorTwoModifier implements SectorTwoModifier {
    ;
    ...
    MineWarfareSectorTwoModifier(String id, String label, ModifierCategory category) {
        this.id = id;
        this.label = label;
