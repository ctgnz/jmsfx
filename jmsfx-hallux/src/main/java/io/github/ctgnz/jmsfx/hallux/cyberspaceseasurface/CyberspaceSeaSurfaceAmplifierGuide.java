package io.github.ctgnz.jmsfx.hallux.cyberspaceseasurface;
...
public enum CyberspaceSeaSurfaceAmplifierGuide implements AmplifierGuide {
    ...
    CyberspaceSeaSurfaceAmplifierGuide(AmplifierEnum amplifier, GuideType type, double... points) {
