...
public class CyberspaceSeaSurfaceSymbolSet implements SymbolSetInfo {
    public static final SymbolSetInfo INSTANCE = new CyberspaceSeaSurfaceSymbolSet();
    ...
    private CyberspaceSeaSurfaceSymbolSet() {
    }

    @Override
    public List<AmplifierGuide> getAmplifierGuides() {
        return Arrays.asList(CyberspaceSeaSurfaceAmplifierGuide.values());
    }
