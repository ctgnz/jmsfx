...
public class LandUnitsSymbolSet implements ISymbolSetInfo {
    public static final ISymbolSetInfo INSTANCE = new LandUnitsSymbolSet();
    ...
    public List<IAmplifierGuide> getAmplifierGuides() {
        return Arrays.asList(
            ...
            new AmplifierGuide(Amplifier.Q_DirectionOfMovementIndicator, GuideType.POLYLINE, 304.754, 600, 304.754, 740.084, 380.942, 772.447),
            new AmplifierGuide(Amplifier.R_MobilityIndicator, GuideType.RECTANGLE, 185, 520, 240, 80),
            ...
            new AmplifierGuide(Amplifier.Z_Speed, GuideType.RECTANGLE, 0, 516, 126, 80),
            new AmplifierGuide(Amplifier.AA_NamedC2Headquarters, GuideType.RECTANGLE, 205.444, 346, 200, 98),
            new AmplifierGuide(Amplifier.AB_FeintDummyIndicator, GuideType.POLYLINE, 126.082, 276, 304.754, 133, 486, 276),
            ...
            new AmplifierGuide(Amplifier.AO_EngagementBar, GuideType.RECTANGLE, 130, 50, 350, 80),
