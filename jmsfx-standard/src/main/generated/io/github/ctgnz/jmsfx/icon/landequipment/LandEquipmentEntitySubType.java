...
public enum LandEquipmentEntitySubType implements EntitySubType {
    ...
    ARMOURED_FIGHTING_VEHICLE("01", "Armoured Fighting Vehicle", LandEquipmentEntityType.VEHICLE_ARMOURED, IconType.FULL_OCTAGON),
    ARMOURED_FIGHTING_VEHICLE_C2("02", "Armoured Fighting Vehicle Command and Control", LandEquipmentEntityType.VEHICLE_ARMOURED, IconType.FULL_OCTAGON),
    ARMOURED_PERSONNEL_CARRIER("03", "Armoured Personnel Carrier", LandEquipmentEntityType.VEHICLE_ARMOURED, IconType.FULL_OCTAGON),
    ARMOURED_PERSONNEL_CARRIER_AMBULANCE("04", "Armoured Personnel Carrier Ambulance", LandEquipmentEntityType.VEHICLE_ARMOURED, IconType.FULL_OCTAGON),
    ARMOURED_PROTECTED_VEHICLE("05", "Armoured Protected Vehicle", LandEquipmentEntityType.VEHICLE_ARMOURED, IconType.MAIN),
    ARMOURED_PERSONNEL_CARRIER_RECOVERY("08", "Armoured Personnel Carrier-Recovery", LandEquipmentEntityType.VEHICLE_ARMOURED, IconType.FULL_OCTAGON),
    COMBAT_SERVICE_SUPPORT_VEHICLE("09", "Combat Service Support Vehicle", LandEquipmentEntityType.VEHICLE_ARMOURED, IconType.FULL_OCTAGON),
    LIGHT_ARMOURED_RECONNAISSANCE("11", "Light Armoured Reconnaissance", LandEquipmentEntityType.VEHICLE_ARMOURED, IconType.FULL_OCTAGON),
    ...
    ARMOURED_CARRIER_VOLCANO("02", "Armoured Carrier with Volcano", LandEquipmentEntityType.MINE_LAYING_EQUIPMENT, IconType.FULL_OCTAGON),
    TRUCK_VOLCANO("03", "Truck Mounted with Volcano", LandEquipmentEntityType.MINE_LAYING_EQUIPMENT, IconType.FULL_OCTAGON),
    DOZER_ARMOURED("01", "Dozer-Armoured", LandEquipmentEntityType.DOZER, IconType.FULL_OCTAGON),
    ...
    LandEquipmentEntitySubType(String id, String label, LandEquipmentEntityType entityType, IconType iconType) {
        this.id = id;
        this.label = label;
