...
public enum SeaSurfaceSectorOneModifier implements ISectorOneModifier {
    ...
    SeaSurfaceSectorOneModifier(String id, String label, String category, SymbolSet symbolSet) {
        this.id = id;
        this.label = label;
