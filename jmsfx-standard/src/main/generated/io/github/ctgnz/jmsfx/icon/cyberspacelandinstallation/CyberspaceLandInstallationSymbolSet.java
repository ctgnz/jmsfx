...
public class CyberspaceLandInstallationSymbolSet implements ISymbolSetInfo {
    public static final ISymbolSetInfo INSTANCE = new CyberspaceLandInstallationSymbolSet();
    private static final List<IEntity> ENTITIES = Arrays.asList(CyberspaceLandInstallationEntity.values());
    private static final Multimap<IEntity, IEntityType> ENTITY_TYPES = Multimaps.index(Arrays.asList(CyberspaceLandInstallationEntityType.values()), IEntityType::getEntity);

    private CyberspaceLandInstallationSymbolSet() {
    }
