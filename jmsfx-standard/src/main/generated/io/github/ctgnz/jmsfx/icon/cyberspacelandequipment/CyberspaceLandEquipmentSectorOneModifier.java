...
public enum CyberspaceLandEquipmentSectorOneModifier implements ISectorOneModifier {
    ...
    CyberspaceLandEquipmentSectorOneModifier(String id, String label, String category, SymbolSet symbolSet) {
        this.id = id;
        this.label = label;
