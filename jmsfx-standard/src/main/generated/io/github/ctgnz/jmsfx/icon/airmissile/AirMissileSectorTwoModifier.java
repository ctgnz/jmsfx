...
public enum AirMissileSectorTwoModifier implements ISectorTwoModifier {
    ...
    AirMissileSectorTwoModifier(String id, String label, String category, SymbolSet symbolSet) {
        this.id = id;
        this.label = label;
