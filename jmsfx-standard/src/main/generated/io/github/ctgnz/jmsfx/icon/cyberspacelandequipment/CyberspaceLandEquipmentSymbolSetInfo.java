...
public class CyberspaceLandEquipmentSymbolSetInfo implements ISymbolSetInfo {
    public static final ISymbolSetInfo INSTANCE = new CyberspaceLandEquipmentSymbolSetInfo();
    private static final List<IEntity> ENTITIES = Arrays.asList(CyberspaceLandEquipmentEntity.values());
    private static final Multimap<IEntity, IEntityType> ENTITY_TYPES = Multimaps.index(Arrays.asList(CyberspaceLandEquipmentEntityType.values()), IEntityType::getEntity);
