...
public enum LandInstallationSectorTwoModifier implements ISectorTwoModifier {
    ...
    LandInstallationSectorTwoModifier(String id, String label, String category, SymbolSet symbolSet) {
        this.id = id;
        this.label = label;
