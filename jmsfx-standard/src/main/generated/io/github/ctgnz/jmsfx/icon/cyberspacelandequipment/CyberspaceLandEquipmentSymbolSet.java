...
public class CyberspaceLandEquipmentSymbolSet implements ISymbolSetInfo {
    public static final ISymbolSetInfo INSTANCE = new CyberspaceLandEquipmentSymbolSet();
