...
public class CyberspaceSymbolSetInfo implements ISymbolSetInfo {
    public static final ISymbolSetInfo INSTANCE = new CyberspaceSymbolSetInfo();
    private static final List<IEntity> ENTITIES = Arrays.asList(CyberspaceEntity.values());
    private static final Multimap<IEntity, IEntityType> ENTITY_TYPES = Multimaps.index(Arrays.asList(CyberspaceEntityType.values()), IEntityType::getEntity);
