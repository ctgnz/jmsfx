...
public enum CyberspaceAirSectorOneModifier implements ISectorOneModifier {
    ...
    CyberspaceAirSectorOneModifier(String id, String label, String category, SymbolSet symbolSet) {
        this.id = id;
        this.label = label;
