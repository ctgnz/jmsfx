...
public enum CyberspaceSpaceSectorTwoModifier implements ISectorTwoModifier {
    ...
    CyberspaceSpaceSectorTwoModifier(String id, String label, String category, SymbolSet symbolSet) {
        this.id = id;
        this.label = label;
