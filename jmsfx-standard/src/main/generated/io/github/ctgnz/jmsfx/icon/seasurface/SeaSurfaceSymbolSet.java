...
public class SeaSurfaceSymbolSet implements ISymbolSetInfo {
    public static final ISymbolSetInfo INSTANCE = new SeaSurfaceSymbolSet();
    private static final List<IEntity> ENTITIES = Arrays.asList(SeaSurfaceEntity.values());
    private static final Multimap<IEntity, IEntityType> ENTITY_TYPES = Multimaps.index(Arrays.asList(SeaSurfaceEntityType.values()), IEntityType::getEntity);
    private static final Multimap<IEntityType, IEntitySubType> ENTITY_SUB_TYPES = Multimaps.index(Arrays.asList(SeaSurfaceEntitySubType.values()), IEntitySubType::getEntityType);

    private SeaSurfaceSymbolSet() {
    }
