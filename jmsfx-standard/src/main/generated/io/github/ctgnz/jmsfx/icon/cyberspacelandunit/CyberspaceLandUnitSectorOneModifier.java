...
public enum CyberspaceLandUnitSectorOneModifier implements ISectorOneModifier {
    ...
    CyberspaceLandUnitSectorOneModifier(String id, String label, String category, SymbolSet symbolSet) {
        this.id = id;
        this.label = label;
