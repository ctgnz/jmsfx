...
public enum CyberspaceSpaceSectorOneModifier implements ISectorOneModifier {
    ...
    CyberspaceSpaceSectorOneModifier(String id, String label, String category, SymbolSet symbolSet) {
        this.id = id;
        this.label = label;
