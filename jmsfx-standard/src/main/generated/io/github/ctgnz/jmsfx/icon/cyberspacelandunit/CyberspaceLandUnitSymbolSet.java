...
public class CyberspaceLandUnitSymbolSet implements ISymbolSetInfo {
    public static final ISymbolSetInfo INSTANCE = new CyberspaceLandUnitSymbolSet();
    private static final List<IEntity> ENTITIES = Arrays.asList(CyberspaceLandUnitEntity.values());
    private static final Multimap<IEntity, IEntityType> ENTITY_TYPES = Multimaps.index(Arrays.asList(CyberspaceLandUnitEntityType.values()), IEntityType::getEntity);

    private CyberspaceLandUnitSymbolSet() {
    }
