...
public class CyberspaceDismountedIndividualSymbolSet implements ISymbolSetInfo {
    public static final ISymbolSetInfo INSTANCE = new CyberspaceDismountedIndividualSymbolSet();
    private static final List<IEntity> ENTITIES = Arrays.asList(CyberspaceDismountedIndividualEntity.values());
    private static final Multimap<IEntity, IEntityType> ENTITY_TYPES = Multimaps.index(Arrays.asList(CyberspaceDismountedIndividualEntityType.values()), IEntityType::getEntity);

    private CyberspaceDismountedIndividualSymbolSet() {
    }
