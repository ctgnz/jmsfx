...
public class CyberspaceAirSymbolSet implements ISymbolSetInfo {
    public static final ISymbolSetInfo INSTANCE = new CyberspaceAirSymbolSet();
    private static final List<IEntity> ENTITIES = Arrays.asList(CyberspaceAirEntity.values());
    private static final Multimap<IEntity, IEntityType> ENTITY_TYPES = Multimaps.index(Arrays.asList(CyberspaceAirEntityType.values()), IEntityType::getEntity);

    private CyberspaceAirSymbolSet() {
    }
