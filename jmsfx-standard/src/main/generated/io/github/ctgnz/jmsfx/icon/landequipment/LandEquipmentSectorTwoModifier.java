...
public enum LandEquipmentSectorTwoModifier implements ISectorTwoModifier {
    ...
    LandEquipmentSectorTwoModifier(String id, String label, String category, SymbolSet symbolSet) {
        this.id = id;
        this.label = label;
