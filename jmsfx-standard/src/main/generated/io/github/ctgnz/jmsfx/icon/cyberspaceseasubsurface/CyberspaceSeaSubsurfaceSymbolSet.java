...
public class CyberspaceSeaSubsurfaceSymbolSet implements ISymbolSetInfo {
    public static final ISymbolSetInfo INSTANCE = new CyberspaceSeaSubsurfaceSymbolSet();
    private static final List<IEntity> ENTITIES = Arrays.asList(CyberspaceSeaSubsurfaceEntity.values());
    private static final Multimap<IEntity, IEntityType> ENTITY_TYPES = Multimaps.index(Arrays.asList(CyberspaceSeaSubsurfaceEntityType.values()), IEntityType::getEntity);
