...
public enum LandUnitsSectorTwoModifier implements SectorTwoModifier {
    ...
    GUERILLA("58", "Guerilla", SymbolSet.SS_LAND_UNIT),
    AIR_ASSAULT("59", "Air Assault", SymbolSet.SS_LAND_UNIT),
    AMPHIBIOUS("60", "Amphibious", SymbolSet.SS_LAND_UNIT),
    VERY_HEAVY("61", "Very Heavy", SymbolSet.SS_LAND_UNIT),
    SUPPLY("62", "Supply", SymbolSet.SS_LAND_UNIT),
    NAVY_BARGE_SELF_PROPELLED("64", "Navy Barge Self-Propelled", SymbolSet.SS_LAND_UNIT),
    NAVY_BARGE_NOT_SELF_PROPELLED("65", "Navy Barge Not Self-Propelled", SymbolSet.SS_LAND_UNIT),
    LAUNCH("66", "Launch", SymbolSet.SS_LAND_UNIT),
    LANDING_CRAFT("67", "Landing Craft", SymbolSet.SS_LAND_UNIT),
    LANDING_SHIP("68", "Landing Ship", SymbolSet.SS_LAND_UNIT),
    SERVICE_CRAFT_YARD("69", "Service Craft/Yard", SymbolSet.SS_LAND_UNIT),
    TUG_HARBOUR("70", "Tug, Harbour", SymbolSet.SS_LAND_UNIT),
    TUG_BOAT_OCEAN_GOING("71", "Tug Boat, Ocean-going", SymbolSet.SS_LAND_UNIT),
    SURFACE_DEPLOYMENT_DISTRIBUTION_COMMAND("72", "Surface Deployment and Distribution Command (SDDC)", SymbolSet.SS_LAND_UNIT),
    NON_COMBATANT_VESSEL("73", "Non-Combatant Vessel, Generic", SymbolSet.SS_LAND_UNIT),
    COMPOSITE("74", "Composite", SymbolSet.SS_LAND_UNIT),
    SHELTER("75", "Shelter", SymbolSet.SS_LAND_UNIT),
    SURGICAL("81", "Surgical", SymbolSet.SS_LAND_UNIT),
    BLOOD_SUPPORT("82", "Blood Support", SymbolSet.SS_LAND_UNIT),
    COMBAT_OPERATIONAL_STRESS_CONTROL("83", "Combat and Operational Stress Control (COSC)", SymbolSet.SS_LAND_UNIT),
    JAMMING("84", "Jamming", SymbolSet.SS_LAND_UNIT),
    OPTOMETRY("86", "Optometry", SymbolSet.SS_LAND_UNIT),
    PREVENTATIVE_MEDICINE("87", "Preventative Medicine", SymbolSet.SS_LAND_UNIT);
