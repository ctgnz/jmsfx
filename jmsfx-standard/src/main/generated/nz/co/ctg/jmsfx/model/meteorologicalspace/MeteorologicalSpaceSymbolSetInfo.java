...
public class MeteorologicalSpaceSymbolSetInfo implements SymbolSetInfo {
    public static final SymbolSetInfo INSTANCE = new MeteorologicalSpaceSymbolSetInfo();
    private static final List<Entity> ENTITIES = Arrays.asList(MeteorologicalSpaceEntity.values());

    private MeteorologicalSpaceSymbolSetInfo() {
    }
