...
public enum LandEquipmentEntityType implements EntityType {
    ...
    VEHICLE_ARMOURED("01", "Armoured Vehicle", LandEquipmentEntity.VEHICLE, IconType.FULL_OCTAGON),
    ...
    ARMOURED_ASSAULT("12", "Armoured Assault", LandEquipmentEntity.ENGINEER_VEHICLES_EQUIPMENT, IconType.FULL_OCTAGON),
    ARMOURED_ENGINEER_RECON_VEHICLE_AERV("13", "Armoured Engineer Recon Vehicle (AERV)", LandEquipmentEntity.ENGINEER_VEHICLES_EQUIPMENT, IconType.FULL_OCTAGON),
