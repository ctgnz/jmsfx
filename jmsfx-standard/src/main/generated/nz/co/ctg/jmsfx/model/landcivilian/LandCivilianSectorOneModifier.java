...
public enum LandCivilianSectorOneModifier implements SectorOneModifier {
    ...
    ASSASSINATION_MOD("01", "Assassination", SymbolSet.SS_LAND_CIVILIAN),
    EXECUTION_MOD("02", "Execution (Wrongful Killing)", SymbolSet.SS_LAND_CIVILIAN),
    MURDER_VICTIMS_MOD("03", "Murder Victims", SymbolSet.SS_LAND_CIVILIAN),
    HIJACKING_MOD("04", "Hijacking", SymbolSet.SS_LAND_CIVILIAN),
    KIDNAPPING_MOD("05", "Kidnapping", SymbolSet.SS_LAND_CIVILIAN),
    PIRACY_MOD("06", "Piracy", SymbolSet.SS_LAND_CIVILIAN),
    RAPE_MOD("07", "Rape", SymbolSet.SS_LAND_CIVILIAN),
    CIVILIAN_MOD("08", "Civilian", SymbolSet.SS_LAND_CIVILIAN),
    ...
    GOVERNMENT_ORGANIZATION_MOD("12", "Government Organization", SymbolSet.SS_LAND_CIVILIAN),
    ...
    ACCIDENT_MOD("21", "Accident", SymbolSet.SS_LAND_CIVILIAN),
    COMBAT_MOD("22", "Combat", SymbolSet.SS_LAND_CIVILIAN),
