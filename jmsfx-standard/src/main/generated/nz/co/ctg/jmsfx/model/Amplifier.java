...
public enum Amplifier  {
    ...
    AD_PlatformType("AD", "Platform Type", AmplifierType.ALPHA, 5, 5, "Electronic Intelligence Notation (ELNOT) or Communications Intelligence Notation (CENOT)"),
    ...
    AO_EngagementBar("AO", "Engagement Bar", AmplifierType.LIST, 6, 10, "An amplifier placed immediately atop the symbol. May denote, 1) local/remote status; 2) engagement status; and 3) weapon type."),
