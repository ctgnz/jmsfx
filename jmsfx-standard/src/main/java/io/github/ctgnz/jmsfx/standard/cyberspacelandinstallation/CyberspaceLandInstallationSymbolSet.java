...
public class CyberspaceLandInstallationSymbolSet implements SymbolSetInfo {
    public static final SymbolSetInfo INSTANCE = new CyberspaceLandInstallationSymbolSet();
    ...
    public List<AmplifierGuide> getAmplifierGuides() {
        return Arrays.asList(CyberspaceLandInstallationAmplifierGuide.values());
    }
