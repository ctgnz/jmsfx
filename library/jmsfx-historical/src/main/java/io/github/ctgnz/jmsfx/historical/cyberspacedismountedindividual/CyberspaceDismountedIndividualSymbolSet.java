package io.github.ctgnz.jmsfx.historical.cyberspacedismountedindividual;
...
public class CyberspaceDismountedIndividualSymbolSet implements SymbolSetInfo {
    public static final SymbolSetInfo INSTANCE = new CyberspaceDismountedIndividualSymbolSet();
    ...
    public List<AmplifierGuide> getAmplifierGuides() {
        return Arrays.asList(CyberspaceDismountedIndividualAmplifierGuide.values());
    }
