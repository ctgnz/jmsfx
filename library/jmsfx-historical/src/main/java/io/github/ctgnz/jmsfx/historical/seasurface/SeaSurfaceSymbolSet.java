...
import io.github.ctgnz.jmsfx.historical.amplifier.TowedArrayType;

public class SeaSurfaceSymbolSet implements SymbolSetInfo {
    public static final SymbolSetInfo INSTANCE = new SeaSurfaceSymbolSet();
    ...
    public List<AmplifierGuide> getAmplifierGuides() {
        return Arrays.asList(SeaSurfaceAmplifierGuide.values());
    }
