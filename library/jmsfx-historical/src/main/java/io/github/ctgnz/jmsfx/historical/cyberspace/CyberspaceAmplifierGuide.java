package io.github.ctgnz.jmsfx.historical.cyberspace;
...
public enum CyberspaceAmplifierGuide implements AmplifierGuide {
    ...
    CyberspaceAmplifierGuide(AmplifierEnum amplifier, GuideType type, double... points) {
