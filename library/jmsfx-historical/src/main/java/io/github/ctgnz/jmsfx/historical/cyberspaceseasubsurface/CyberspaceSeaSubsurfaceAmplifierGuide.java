package io.github.ctgnz.jmsfx.historical.cyberspaceseasubsurface;
...
public enum CyberspaceSeaSubsurfaceAmplifierGuide implements AmplifierGuide {
    ...
    CyberspaceSeaSubsurfaceAmplifierGuide(AmplifierEnum amplifier, GuideType type, double... points) {
