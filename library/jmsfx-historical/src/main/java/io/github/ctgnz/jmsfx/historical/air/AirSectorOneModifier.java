...
public enum AirSectorOneModifier implements SectorOneModifier {
        ...
        LIAISON("A1", "Liaison", ModifierCategory.MissionArea),
        WEATHER("A2", "Weather", ModifierCategory.MissionArea),
        ES("A3", "Electronic Surveillance Measures (ES)", ModifierCategory.MissionArea),
        OBSERVATION("A4", "Observation", ModifierCategory.MissionArea);
