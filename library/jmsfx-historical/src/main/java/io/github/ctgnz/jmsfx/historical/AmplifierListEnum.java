...
import io.github.ctgnz.jmsfx.historical.amplifier.*;
...
public enum AmplifierListEnum implements AmplifierList {
        ...
        EQUIPMENT_MOBILITY("3", "Equipment Mobility", AmplifierEnum.R_MobilityIndicator, EquipmentMobility.class, SymbolSetEnum.LAND_UNIT, SymbolSetEnum.LAND_EQUIPMENT,
