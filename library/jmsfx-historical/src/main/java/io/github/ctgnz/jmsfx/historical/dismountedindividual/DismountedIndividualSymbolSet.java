...
import io.github.ctgnz.jmsfx.historical.amplifier.EquipmentMobility;
import io.github.ctgnz.jmsfx.historical.amplifier.LeadershipRole;

public class DismountedIndividualSymbolSet implements SymbolSetInfo {
    public static final SymbolSetInfo INSTANCE = new DismountedIndividualSymbolSet();
    ...
    private DismountedIndividualSymbolSet() {
    }

    @Override
    public List<AmplifierGuide> getAmplifierGuides() {
        return Arrays.asList(DismountedIndividualAmplifierGuide.values());
    }
