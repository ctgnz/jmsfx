package io.github.ctgnz.jmsfx.historical.cyberspacelandunit;
...
public enum CyberspaceLandUnitAmplifierGuide implements AmplifierGuide {
    ...
    CyberspaceLandUnitAmplifierGuide(AmplifierEnum amplifier, GuideType type, double... points) {
