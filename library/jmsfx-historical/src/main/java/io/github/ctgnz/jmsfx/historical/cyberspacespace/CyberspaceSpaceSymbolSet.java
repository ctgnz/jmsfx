...
public class CyberspaceSpaceSymbolSet implements SymbolSetInfo {
    public static final SymbolSetInfo INSTANCE = new CyberspaceSpaceSymbolSet();
    ...
    private CyberspaceSpaceSymbolSet() {
    }

    @Override
    public List<AmplifierGuide> getAmplifierGuides() {
        return Arrays.asList(CyberspaceSpaceAmplifierGuide.values());
    }
