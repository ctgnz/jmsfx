package io.github.ctgnz.jmsfx.historical.cyberspacespace;
...
public enum CyberspaceSpaceAmplifierGuide implements AmplifierGuide {
    ...
    CyberspaceSpaceAmplifierGuide(AmplifierEnum amplifier, GuideType type, double... points) {
