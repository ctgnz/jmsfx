...
public enum CyberspaceLandInstallationAmplifierGuide implements AmplifierGuide {
    ...
    CyberspaceLandInstallationAmplifierGuide(AmplifierEnum amplifier, GuideType type, double... points) {
