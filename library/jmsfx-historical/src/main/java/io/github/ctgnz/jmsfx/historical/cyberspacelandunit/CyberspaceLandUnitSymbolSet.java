...
public class CyberspaceLandUnitSymbolSet implements SymbolSetInfo {
    public static final SymbolSetInfo INSTANCE = new CyberspaceLandUnitSymbolSet();
    ...
    public List<AmplifierGuide> getAmplifierGuides() {
        return Arrays.asList(CyberspaceLandUnitAmplifierGuide.values());
    }
