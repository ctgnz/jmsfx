package io.github.ctgnz.jmsfx.hallux.cyberspacelandequipment;
...
public enum CyberspaceLandEquipmentAmplifierGuide implements AmplifierGuide {
    ...
    CyberspaceLandEquipmentAmplifierGuide(AmplifierEnum amplifier, GuideType type, double... points) {
