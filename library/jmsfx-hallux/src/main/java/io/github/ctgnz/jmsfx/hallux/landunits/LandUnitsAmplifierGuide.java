package io.github.ctgnz.jmsfx.hallux.landunits;
...
public enum LandUnitsAmplifierGuide implements AmplifierGuide {
        ...
        Q(AmplifierEnum.Q_DirectionOfMovementIndicator, GuideType.POLYLINE, 304.754, 600, 304.754, 740.084, 380.942, 772.447),
        R(AmplifierEnum.R_MobilityIndicator, GuideType.RECTANGLE, 185, 520, 240, 80),
        ...
        Z(AmplifierEnum.Z_Speed, GuideType.RECTANGLE, 0, 516, 126, 80),
        AA(AmplifierEnum.AA_NamedC2Headquarters, GuideType.RECTANGLE, 205.444, 346, 200, 98),
        AB(AmplifierEnum.AB_FeintDummyIndicator, GuideType.POLYLINE, 126.082, 276, 304.754, 133, 486, 276),
        ...
        AO(AmplifierEnum.AO_EngagementBar, GuideType.RECTANGLE, 130, 50, 350, 80),
    ...
    LandUnitsAmplifierGuide(AmplifierEnum amplifier, GuideType type, double... points) {
