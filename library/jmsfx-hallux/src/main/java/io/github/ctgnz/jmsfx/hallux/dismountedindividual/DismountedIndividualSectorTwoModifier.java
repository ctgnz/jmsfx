...
public enum DismountedIndividualSectorTwoModifier implements SectorTwoModifier {
        ...
        OFA("A1", "OF-1A", ModifierCategory.Rank),
        CIV("A2", "Civilian", ModifierCategory.Rank),
        CDR("A3", "Commander", ModifierCategory.FunctionalStaffArea),
        SIC("A4", "Second-in-Command", ModifierCategory.FunctionalStaffArea),
        SEA("A5", "Senior Enlisted Advisor", ModifierCategory.FunctionalStaffArea),
        COMMAND_CONTROL_MOD2("B1", "Command/Control", ModifierCategory.Crew),
        DRIVER_MOD2("B2", "Driver", ModifierCategory.Crew),
        GUNNER_MOD2("B3", "Gunner", ModifierCategory.Crew),
        LOADER_MOD2("B4", "Loader", ModifierCategory.Crew),
        PILOT_MOD2("B5", "Pilot", ModifierCategory.Crew),
        NAVIGATOR_MOD2("B6", "Navigator", ModifierCategory.Crew),
        FLIGHT_ENGINEER_MOD2("B7", "Flight Engineer", ModifierCategory.Crew),
        OPERATOR_MOD2("B8", "Operator", ModifierCategory.Crew),
        OBSERVER_MOD2("B9", "Observer", ModifierCategory.Crew),
        SIGNAL_MOD2("BA", "Signal", ModifierCategory.Crew),
        MEDICAL_MOD2("BB", "Medical", ModifierCategory.Crew),
        LOGISTICS_MOD2("BC", "Logistics", ModifierCategory.Crew),
        MAINTENANCE_MOD2("BD", "Maintenance", ModifierCategory.Crew),
        FAO_MOD2("BE", "FAO", ModifierCategory.Crew);
