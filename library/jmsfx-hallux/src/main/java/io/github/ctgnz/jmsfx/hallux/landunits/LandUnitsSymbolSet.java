...
import io.github.ctgnz.jmsfx.hallux.amplifier.ServiceTier;
import io.github.ctgnz.jmsfx.hallux.amplifier.UnitEchelon;
...
public class LandUnitsSymbolSet implements SymbolSetInfo {
    ...
    public List<StandardAmplifierItem> getFrameAmplifiers() {
        return Arrays.asList(ServiceTier.values());
    }
