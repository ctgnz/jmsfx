...
public class CyberspaceAirSymbolSet implements SymbolSetInfo {
    public static final SymbolSetInfo INSTANCE = new CyberspaceAirSymbolSet();
    ...
    public List<AmplifierGuide> getAmplifierGuides() {
        return Arrays.asList(CyberspaceAirAmplifierGuide.values());
    }
