...
public enum Amplifier  {
    ...
    AreaOfUncertainty("AH2", "Area Of Uncertainty", "A graphic modifier for units, equipment and installations that indicates the area where an object is most likely to be, based on the object's last report and the reporting accuracty of the sensor that detected the object."),
    HeadquartersElement("AH", "Headquarters Element", "A text modifier for units, equipment and installations that indicates what type of element of a headquarters is being represented, such as TOC, MAIN."),
